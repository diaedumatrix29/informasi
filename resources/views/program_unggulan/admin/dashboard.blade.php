...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/program-unggulan/input-data-program-unggulan">Tambah</a>
        ...
        <tbody>
            ...
            @foreach($program_unggulan as $program)
                <tr>
                    ...
                    <td><a href="">{{ $program->link }}</a></td>

                    <td><a href="{{ URL::to('/') }}/program-unggulan/edit/{{ $program->nama_program }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/program-unggulan/delete/{{ $program->id }}">
                        @csrf
                        @method('DELETE')
