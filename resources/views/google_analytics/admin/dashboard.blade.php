...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/google-analitycs/input-data-google-analitycs">Tambah</a>
    <table class="table table-striped border">
        ...
        <tbody>
            ...
            @foreach($google_analytics as $analytics)
                <tr>
                    <td>{{ $analytics->src }}</td>

                    <td><a href="{{ URL::to('/') }}/google-analitycs/edit/{{ $analytics->id }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/google-analitycs/delete/{{ $analytics->id }}">
                        @csrf
                        @method('DELETE')
