...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/office/input-data-office">Tambah</a>
    <table class="table table-striped border">
        <thead>
            <tr>
                <th scope="col">Judul Office</th>
                <th scope="col">Isi Office</th>
        ...
        <tbody>
            ...
            @foreach($office as $o)
                <tr>
                    <td>{{ $o->judul_office }}</td>
                    <td>{!! $o->isi_office !!}</td>

                    <td><a href="{{ URL::to('/') }}/office/edit/{{ $o->judul_office }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/office/delete/{{ $o->id }}">
                        @csrf
                        @method('DELETE')
