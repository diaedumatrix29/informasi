...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/diskon/input-data-diskon">Tambah</a>
    <table class="table table-striped border">
        <thead>
            <tr>
                <th scope="col">Foto diskon</th>
                <th scope="col">Link</th>
                <th scope="col">Edit diskon</th>
        ...
        <tbody>
            @foreach($diskon as $disc)
                <tr>
                    <td><img src="{{ asset('storage/images/diskon/' .$disc->foto_diskon) }}" class="" width="75"></td>
                    <td>{{ $disc->link }}</td>
                    <td><a href="{{ URL::to('/') }}/diskon/edit/{{ $disc->id }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/diskon/delete/{{ $disc->id }}">
                        @csrf
                        @method('DELETE')
