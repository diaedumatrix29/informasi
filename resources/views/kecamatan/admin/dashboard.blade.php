...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/kecamatan/input-data-kecamatan">Tambah Kecamatan</a>
    ...
    <table class="table table-striped border">
        <thead>
            <tr>
                ...
                <th scope="col">Edit Kecamatan</th>
        ...
        <tbody>
            @foreach($kecamatan as $k)
                <tr>
                    <td>{{ $k->kotanya->nama_kota }}</td>
                    <td>{{ $k->nama_kecamatan }}</td>
                    <td><a href="{{ URL::to('/') }}/kecamatan/edit/{{ $k->nama_kecamatan }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/kecamatan/delete/{{ $k->id }}">
                        @csrf
                        @method('DELETE')
