...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/promosi-home-page/input-data-promosi-home-page">Tambah</a>
        ...
        <tbody>
            ...
            @foreach($promosi_home_page as $promosi)
                <tr>
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/promosi-home-page/delete/{{ $promosi->id }}">
                        @csrf
                        @method('DELETE')
