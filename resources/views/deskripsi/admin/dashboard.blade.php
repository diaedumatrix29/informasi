...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/deskripsi/input-data-deskripsi">Tambah</a>
    <table class="table table-striped border">
        <thead>
            <tr>
                <th scope="col">Isi Deskripsi</th>
        ...
        <tbody>
            ...
            @foreach($deskripsi as $desc)
                <tr>
                    <td>{!! $desc->isi_deskripsi !!}</td>

                    <td><a href="{{ URL::to('/') }}/deskripsi/edit/{{ $desc->id }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/deskripsi/delete/{{ $desc->id }}">
                        @csrf
                        @method('DELETE')
