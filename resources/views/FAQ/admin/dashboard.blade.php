...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/FAQ/input-data-faq">Tambah</a>
        ...
        <tbody>
            @foreach($FAQ as $faq)
                <tr>
                    ...
                    <td><a href="{{ URL::to('/') }}/FAQ/edit/{{ $faq->pertanyaan }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST" action="/FAQ/delete/{{ $faq->id }}">
                        @csrf
                        @method('DELETE')
