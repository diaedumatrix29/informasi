...
<div class="container">
    ...
    <a class="btn btn-primary mb-4" style="float: right;"
        href="{{ URL::to('/') }}/reservasi/input-data-reservasi">Tambah</a>
        ...
        <tbody>
            ...
            @foreach($reservasi as $r)
                <tr>
                    ...
                    <td>{{ $r->no_hp }}</td>
                    <td>{{ $r->no_wa }}</td>
                    <td><a href="">{{ $r->link }}</a></td>
                    <td><a
                            href="{{ URL::to('/') }}/reservasi/edit/{{ $r->nama_reservasi }}"><svg
                    ...
                    <form name="delete-form" id="adelete-form" method="POST"
                        action="/reservasi/delete/{{ $r->id }}">
                        @csrf
                        @method('DELETE')
